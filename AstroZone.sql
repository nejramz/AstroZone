...
--
-- Host: localhost
-- Generation Time: May 25, 2022 at 03:27 AM
...
INSERT INTO `signs` (`SID`, `NAME`) VALUES
(1, 'Capricorn '),
(2, 'Aquarius'),
(3, 'Pisces'),
(4, 'Aries'),
...
--
ALTER TABLE `matches`
  MODIFY `PID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=183;
...
--
ALTER TABLE `descriptions`
  ADD CONSTRAINT `descriptions_ibfk_1` FOREIGN KEY (`SIGN`) REFERENCES `signs` (`SID`),
  ADD CONSTRAINT `descriptions_ibfk_2` FOREIGN KEY (`PLANET`) REFERENCES `planets` (`PID`);

--
-- Constraints for table `matches`
--
ALTER TABLE `matches`
  ADD CONSTRAINT `matches_ibfk_1` FOREIGN KEY (`SIGN`) REFERENCES `signs` (`SID`),
  ADD CONSTRAINT `matches_ibfk_2` FOREIGN KEY (`PLANET`) REFERENCES `planets` (`PID`),
  ADD CONSTRAINT `matches_ibfk_3` FOREIGN KEY (`DESCRIPTION`) REFERENCES `descriptions` (`DID`);

--
-- Constraints for table `natal_chart_details`
--
ALTER TABLE `natal_chart_details`
  ADD CONSTRAINT `natal_chart_details_ibfk_1` FOREIGN KEY (`PLACEMENT`) REFERENCES `matches` (`PID`),
  ADD CONSTRAINT `natal_chart_details_ibfk_2` FOREIGN KEY (`USER`) REFERENCES `users` (`UID`);
COMMIT;
